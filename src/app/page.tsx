...
export default function Home() {
  ...
  return (
    <div className={`min-h-full flex flex-col lg:flex-row items-center lg:items-start justify-center p-4 py-8 gap-8 relative overflow-hidden transition-colors duration-1000 ${theme === 'matrix' ? 'bg-black text-green-500' : ''}`}>
      ...
      <button onClick={quitGame} className="absolute top-4 left-4 text-white/50 hover:text-white/90 text-sm font-medium z-10 bg-white/5 hover:bg-white/5 px-4 py-2 rounded-full border border-white/10 backdrop-blur-md transition-colors shadow-lg">
        &larr; Resign
      </button>
